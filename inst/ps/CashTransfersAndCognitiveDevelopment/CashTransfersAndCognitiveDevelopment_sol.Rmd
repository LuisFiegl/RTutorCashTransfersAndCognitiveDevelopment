...
In R you can create causal structures with the package `DiagrammeR`. You can load it with `library(DiagrammeR)`. It contains the function `grViz`. You can create the following causal structure on your own with this code:
...
#< quiz "exercise2_1_1"
question: Given this data, do you think the authors concluded that these are disadvantaged children?
sc:
    - yes*
    - no
success: Good intuition! There are a number of variables that indicate that the children from our dataset are disadvantaged.
failure: That's not quite what one would expect! Take a closer look at the education of the parents or physical characteristics like the Height-for-age z-score...
#>
...
sc:
    ...
    - Time to municipal headquarter in hours (`s3ap25_hqtime_h_05`)
